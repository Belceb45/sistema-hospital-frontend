    ...
    <footer className="bg-primary text-white pt-16 pb-8 border-t border-blue-700">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          <div className="space-y-4">
            ...
            <p className="text-blue-100 text-sm leading-relaxed opacity-90">
              Comprometidos con tu salud. Tecnología de vanguardia y
              especialistas certificados para brindarte la mejor atención.
            </p>
            <div className="flex gap-4 pt-2">
              <a
                href="#"
                className="hover:bg-blue-700 p-2 rounded-full transition-all"
              >
                <Facebook size={20} />
              </a>
              <a
          ...
          <div>
            <h3 className="font-bold mb-6 text-blue-200 uppercase tracking-wider text-xs">
              Navegación
            </h3>
            <ul className="space-y-3 text-sm font-medium">
              <li>
                <Link
                  to="/board"
                  className="hover:text-blue-200 hover:translate-x-1 transition-all flex items-center gap-2"
                >
              ...
              <li>
                <Link
                  ...
                  className="hover:text-blue-200 hover:translate-x-1 transition-all flex items-center gap-2"
                >
                  <ArrowRight size={14} className="text-blue-400" /> Agendar
                  Cita
                </Link>
              </li>
              <li>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span className="opacity-90">
                  Riobamba 639, Magdalena de las Salinas,
                  <br />
          ...
          <div className="">
            <span className="text-[10px] text-slate-400 mb-1 uppercase tracking-wider font-semibold">
              Desarrollado por
            </span>
            <img
              src={logoEscom}
        ...
        <div className="border-t border-blue-700 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-blue-200">
          <p>
            © {new Date().getFullYear()} Hospital System. Todos los derechos
            reservados.
          </p>
